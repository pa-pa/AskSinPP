...
//typedef AskSin<StatusLed<LED_PIN>,BattSensor<SyncMeter<InternalVCC,350>>,Radio<RadioSPI,2> > Hal;
typedef AskSin<StatusLed<LED_PIN>,BattSensor<AsyncMeter<InternalVCC,350>>,Radio<RadioSPI,2> > Hal;
