...
class DimmerChannel : public Channel<DimmerList1,DimmerList3,EmptyList,PeerCount>, public DimmerStateMachine {

protected:
  typedef Channel<DimmerList1,DimmerList3,EmptyList,PeerCount> BaseChannel;
...
class DimmerDevice : public MultiChannelDevice<ChannelType,ChannelCount,List0Type> {

  uint8_t pin;

public:
  typedef MultiChannelDevice<ChannelType,ChannelCount,List0Type> DeviceType;
